...
INSERT INTO kt.upms_route (id, application_id, name, code, component, pid, level_path, level, path, icon, hide_children,
...
INSERT INTO kt.upms_permission (id, code, type, resource_id, status, gmt_create, gmt_modified, creator, modifier,
                                is_deleted)
...
truncate table upms_permission_role_rel;
INSERT INTO kt.upms_permission_role_rel (id, permission_id, role_id, gmt_create, gmt_modified, creator, modifier)
...
truncate table upms_user;
INSERT INTO kt.upms_user (id, name, phone, code, password, status, gmt_create, gmt_modified, creator, modifier,
                          is_deleted)
...
truncate table upms_role;
INSERT INTO kt.upms_role (id, name, status, gmt_create, gmt_modified, creator, modifier, is_deleted)
VALUES (1, '超级管理员', 1, '2021-01-21 10:37:00', '2021-01-21 10:37:00', 0, 0, 0);

truncate table upms_user_role_rel;
INSERT INTO kt.upms_user_role_rel (id, user_id, role_id, gmt_create, gmt_modified, creator, modifier)
VALUES (1, 1, 1, '2021-01-21 10:40:47', '2021-01-21 10:40:47', 0, 0);

truncate table upms_api;
INSERT INTO kt.upms_api (id, application_id, name, url, method, status, category_id, auth_type, has_path_variable,
...
INSERT INTO kt.upms_application (id, name, code, status, type, gmt_modified, gmt_create, creator, modifier, is_deleted)
VALUES (1, '权限中心', 'permission', 1, 1, '2021-01-25 15:29:20', '2021-01-25 15:29:20', 0, 0, 0);

truncate table upms_api_category;
INSERT INTO kt.upms_api_category (id, application_id, name, gmt_modified, gmt_create, creator, modifier, is_deleted)
