...
CREATE TABLE IF NOT EXISTS `kt`.`upms_permission_role_rel` (
                                                               ...
                                                               INDEX `fk_application_id_idx` (`application_id` ASC))
    ENGINE = InnoDB
    COMMENT = '角色与权限关联表';
...
CREATE TABLE IF NOT EXISTS `kt`.`upms_api` (
                                               ...
                                               `method` TINYINT(1) NULL DEFAULT 1 COMMENT 'Http Method 1-GET 2-POST 3-PUT 4-DELETE  5-PATCH',
